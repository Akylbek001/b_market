...
public class CertificatesPage extends BasePage {
    ...
    private static final By START_DATE = By.cssSelector("[aria-label='Сентябрь 1, 2024']");
    private static final By END_DATE = By.cssSelector("[aria-label='Сентябрь 8, 2024']");
